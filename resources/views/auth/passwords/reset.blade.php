                                ...
                                <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            @endif
                                            <form method="POST" action="{{ route('password.update') }}" style="width:90% !important; margin: auto;">
                                                @csrf
                                                <input type="hidden" name="token" value="{{ $token }}">
                                                <div class="form-group mb-50">
                                                    <label class="text-bold-600" for="email">Email address</label>
                                                    <input type="email" class="form-control @error('email') is-invalid @enderror"  placeholder="Email address" id="email" name="email" required autocomplete="email" value="{{ $email ?? old('email') }}" autofocus>
                                                    @error('email')
                                                ...
                                                <div class="form-group" style="margin-top: 20px;">
                                                    ...
                                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password-confirm" placeholder="Password" name="password_confirmation" autocomplete="new-password">
                                                </div>

                                                <button type="submit" class="btn btn-primary glow w-100 position-relative">{{ __('Reset Password') }}@php /*<i id="icon-arrow" class="bx bx-right-arrow-alt"></i>*/@endphp</button>
                                            </form>
                                        @php /*<hr>*/ @endphp
