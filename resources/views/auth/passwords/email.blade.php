                                ...
                                <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            @endif
                                            <form method="POST" action="{{ route('password.email') }}" style="width:90% !important; margin: auto;">
                                                @csrf
                                                <div class="form-group mb-50">
                                                    <label class="text-bold-600" for="exampleInputEmail1">Email address</label>
                                                    <input type="email" class="form-control @error('email') is-invalid @enderror"  placeholder="Email address" id="email" name="email" required autocomplete="email" autofocus>
                                                    @error('email')
                                                ...
                                                <button type="submit" class="btn btn-primary glow w-100 position-relative">{{ __('Send Password Reset Link') }}@php /*<i id="icon-arrow" class="bx bx-right-arrow-alt"></i>*/@endphp</button>
                                            </form>
                                        @php /*<hr>*/ @endphp
