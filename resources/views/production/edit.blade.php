                                        ...
                                        <div class="form col-md-12">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <select class="form-control" name="strWarehouse">
                                                        ...
                                                        @foreach($sitesettings as $thissetting)
                                                            @if($thissetting->field=='WareHouse')
                                                                <option value="{{ $thissetting->value }}" @if($production->warehouse==$thissetting->value) selected @endif>{{ $thissetting->value }}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-sm-3">
                                                    ...
                                                    <input type="number" value="{{ $production->predicted_cost }}" name="predicted_cost" id="predicted_cost" class="form-control" placeholder="Predicted cost of goods (ISK)">
                                                </div>
                                                <div class="form-group col-sm-3">
                                                    <label>Actual cost of goods (ISK)</label>
                                                    <input type="number" value="{{ $production->actual_cost }}" name="actual_cost" id="actual_cost" class="form-control" placeholder="Actual cost of goods (ISK)">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-sm-3">
                                                    <label>Production Time (minutes)</label>
                                                    <input type="number" value="{{ $production->production_time_emp }}" name="production_time_emp" id="production_time_emp" class="form-control" placeholder="Production Time per employee in Minutes">
                                                </div>
                                                <div class="form-group col-sm-3">
                                                    <label>Number of employees</label>
                                                    <input type="number" value="{{ $production->num_employees }}" name="num_employees" id="num_employees" class="form-control" placeholder="Number of employees">
                                                </div>
                                                <div class="form-group col-sm-3">
                                                    <label>Total Production Time (minutes)</label>
                                                    <input type="number" value="{{ $production->production_time }}" name="production_time" id="production_time" class="form-control" placeholder="Production Time in Minutes" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
