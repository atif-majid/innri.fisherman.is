...
<head>
    ...
    <title>Sales Opportunity - Edit</title>
        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h5 class="content-header-title float-left pr-1 mb-0">Edit Sales Opportunity</h5>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb p-0 mb-0">
                                ...
                                <li class="breadcrumb-item active">Edit sales opportunity
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="form col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="strPhoneNumber" value="{{$salesopportunity->phone_number}}" class="form-control" <?php /*data-validation-required-message="Phone number required"*/?> placeholder="Phone Number">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm">
                                                        <label>Email</label>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="controls">
                                                            <select class="form-control" id="strPriority" name="strPriority">
                                                                <option value="Normal" @if($salesopportunity->sop_priority=='Normal') selected @endif>Normal</option>
                                                                <option value="Priority" @if($salesopportunity->sop_priority=='Priority') selected @endif>Priority</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name="strDescription" class="form-control" <?php /*data-validation-required-message="Name is requried"*/?> placeholder="Description" rows="4">{{$salesopportunity->description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <select class="form-control" id="nAssignedTo" name="nAssignedTo">
                                                                ...
                                                                @foreach ($employees as $employee)
                                                                    <option value="{{ $employee->id }}" @if($salesopportunity->assigned_to==$employee->id) selected @endif>{{ $employee->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name="strResponse" class="form-control" <?php /*data-validation-required-message="Name is requried"*/?> placeholder="Response and Improvements" rows="4">{{$salesopportunity->response}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{ route('salesopportunity.uploadpicture') }}" class="dropzone dropzone-area" id="dpz-remove-thumb" style="margin-left: 20px;margin-right:20px !important;">
                                        ...
                                        <input type="hidden" id="nSoId" name="nSoId" value="{{ $salesopportunity->id }}">
                                        <input type="hidden" id="pgEdit" name="pgEdit" value="{{ $salesopportunity->id }}">
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    Dropzone.options.dpzRemoveThumb = {
        ...
        init: function (e) {
            ...
            $('#btnAllSubmit').on("click", function() {
                ...
                $.ajax({
                    type: "post",
                    url: "{{ route('salesopportunity.updatepost') }}",
                    data: arrFormData,
