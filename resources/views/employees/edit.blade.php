        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h5 class="content-header-title float-left pr-1 mb-0">Update Employee</h5>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form-horizontal" novalidate method="post" action="{{ route('employees.update', $employee->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="name" class="form-control" data-validation-required-message="Name is required" placeholder="Full Name" value="{{ $employee->name }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Email address</label>
                                                    <div class="controls">
                                                        <input type="email" name="email" class="form-control" data-validation-required-message="Must be a valid email address" placeholder="Email address"  value="{{ $employee->email }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="gsm" class="form-control" data-validation-required-message="Mobile phone is required" placeholder="Mobile phone"  value="{{ $employee->gsm }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Address</label>
                                                    <div class="controls">
                                                        <input type="text" name="address" class="form-control" data-validation-required-message="Address is required" placeholder="Address" value="{{ $employee->address }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Post code</label>
                                                    <div class="controls">
                                                        <input type="text" name="postcode" class="form-control" data-validation-required-message="Post code is required" placeholder="Post code" value="{{ $employee->postcode }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>City</label>
                                                    <div class="controls">
                                                        <input type="text" name="city" class="form-control" data-validation-required-message="City is required" placeholder="City" value="{{ $employee->city }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="designation" class="form-control" data-validation-required-message="Job title is required" placeholder="Job title" value="{{ $employee->designation }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Direct Phone</label>
                                                    <div class="controls">
                                                        <input type="text" name="direct_phone" class="form-control" data-validation-required-message="Direct phone is required" placeholder="Direct Phone" value="{{ $employee->direct_phone }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Department</label>
                                                    <div class="controls">
                                                        <input type="text" name="department" class="form-control" data-validation-required-message="Department is required" placeholder="Department"  value="{{ $employee->department }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>H-Number</label>
                                                    <div class="controls">
                                                        <input type="text" name="h_number" class="form-control" data-validation-required-message="H-Number is required" placeholder="H-Number" value="{{ $employee->h_number }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>ID-Number</label>
                                                    <div class="controls">
                                                        <input type="text" name="id_number" class="form-control" data-validation-required-message="ID-Number is required" placeholder="ID-Number" value="{{ $employee->id_number}}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <fieldset class="form-group">
                                                        <select class="form-control" id="userlevel" name="userlevel">
                                                            ...
                                                            <option value="admin" @if($employee->userlevel == 'admin') ? selected : null @endif>Admin</option>
                                                            <option value="edit" @if($employee->userlevel == 'edit') ? selected : null @endif>Edit</option>
                                                            <option value="view" @if($employee->userlevel == 'view') ? selected : null @endif>View</option>
                                                        </select>
                                                    </fieldset>
                                                </div>
                                            </div>
