                                                    ...
                                                    @if($thisTemplateSubmission->with_checkboxes=='yes')
                                                        <td>
                                                            <label class="custom-control custom-checkbox checkbox-input">
                                                                <input type="checkbox" name="chk_entry_{{$fields->id}}" class="checkbox-input custom-control-input" value="yes" readonly @if($fields->chk_emp_confirm=='yes') checked @endif>
