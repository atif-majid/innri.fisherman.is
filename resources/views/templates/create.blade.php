    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h5 class="content-header-title float-left pr-1 mb-0">Add New Template</h5>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb p-0 mb-0">
                                ...
                                <li class="breadcrumb-item active">Add new template
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            ...
            <section class="input-validation">
                <form id="frmNewTemplate" class="form-horizontal"  novalidate method="post" action="{{ route('templates.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                            ...
                                            <div class="form col-md-12">
                                                <div class="row">
                                                    <div class="form-group col-sm">
                                                        <label>Title</label>
                                                        <div class="controls">
                                                            <input type="text" name="strTitle" id="strTitle" value="{{old('strTitle')}}" class="form-control" data-validation-required-message="Title is requried" placeholder="Template title">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm">
                                                        ...
                                                        <select class="form-control" name="nSupervisor" id="nSupervisor">
                                                            ...
                                                            @foreach($allEmployees as $thisemp)
                                                                <option value="{{ $thisemp->id }}" @if($thisemp->id==$nCurrentEmpID) selected @endif>{{ $thisemp->name }}</option>
                                                            @endforeach
                                                            @php
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm">
                                                        <fieldset>
                                                            <div class="checkbox">
                                                                <input type="checkbox" class="checkbox-input" id="chWithCheckbox" name="chWithCheckbox" value="yes">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name="strInstructions" class="form-control" <?php /*data-validation-required-message="Name is requried"*/?> placeholder="Instructions" rows="4">{{old('strInstructions')}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
