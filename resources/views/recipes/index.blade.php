    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class="nav-item"><a href="#"><span class="menu-title">Employees</span></a>
                <ul class="menu-content">
                    <li><a href="{{ route('employees.index') }}"><!--<i class="menu-livicon" data-icon="globe"></i>--><span class="menu-title" data-i18n="Google Maps">Empoloyee Directory</span></a>
                    </li>
            ...
            <section class="users-list-wrapper">
                <div class="users-list-filter px-1">
                    <div class="row  rounded py-2 mb-2">
                        <div class="col-12 col-sm-6 col-lg-3 d-flex align-items-center" onclick="window.location.href='new-recipe.html'">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="users-list-datatable" class="table">
                                        ...
                                        <tr>
                                            <!--<td>300</td>-->
                                            <td>Smoked Trout 300g (10.5oz) bite</td>
                                            <!--<td>Marketing</td>
                                            <td>Suðureyri</td>
                                            <td>661 9900</td>
                                            <td>661 9900</td>
                                        ...
                                        <tr>
                                            <!--<td>300</td>-->
                                            <td>Smoked salmon "húskarlabiti" 200g (7 oz)</td>
                                            <!--<td>Sales</td>
                                            <td>Grandatröó</td>
                                            <td>661 9900</td>
                                            <td>661 9900</td>
                                        ...
                                        <tr>
                                            <!--<td>300</td>-->
                                            <td>Smoked salmon 150g (5,3oz) slices</td>
                                            <!--<td>Development</td>
                                            <td>Grandatröó</td>
                                            <td>661 9900</td>
                                            <td>661 9900</td>
                                        ...
                                        <tr>
                                            <!--<td>300</td>-->
                                            <td>Rope Hung Smoked Salmon 300g (10,5oz) slices</td>
                                            <!--<td>Sales</td>
                                            <td>Fiskislóð</td>
                                            <td>661 9900</td>
                                            <td>661 9900</td>
                                        ...
                                        <tr>
                                            <!--<td>300</td>-->
                                            <td>Cured Salmon "Gravlax " 300g (10,5 oz) slices</td>
                                            <!--<td>Design</td>
                                            <td>624 Sales</td>
                                            <td>661 9900</td>
                                            <td>661 9900</td>
